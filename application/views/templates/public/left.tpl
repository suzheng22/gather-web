	...
	<div class="aside_menu">
		<div class="slimScrollDiv leftsidebar_box">
            ...
            <dl class="record system_log">
                ...
                <dd><a href="base_info_manager.html" title="基本信息管理">基本信息管理</a></dd>
                <dd><a href="extend_info.html" title="扩充成分">扩充成分</a></dd>
                <dd><a href="nutrient_info.html" title="营养成分">营养成分</a></dd>
            </dl>     
