	...
	<div class="aside_menu">
		<div class="slimScrollDiv leftsidebar_box">
            <dl class="user_manager system_log">
                <dt><i class="icon iconfont">&#xf0226;</i>用户管理<img src="{{$resource_url}}images/left/select_xl01.png"></dt>
            ...
            <dl class="record system_log">
                ...
                <dd><a href="{{$root_path}}input/index">录入</a></dd>
            </dl>
            ...
            <dl class="counts system_log">
                ...
                <dd><a href="#" title="录入统计">录入统计</a></dd>
