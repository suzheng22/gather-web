		...
		<div class="slimScrollDiv leftsidebar_box">
			<!--<ul>
				<li class="brand "><a href="javascript:;" title="用户管理"><i class="icon iconfont">&#xf0226;</i>用户管理</a>
					<div class="sub">
						<ul>
						   <li class="aa bb"><a href="{{$root_path}}user/index" title="用户列表">用户管理</a></li>
							<li class="aa"><a href="{{$root_path}}role/index" title="角色管理" class="">角色管理</a></li>
            ...
            <dl class="system_log">
                <dt onClick="changeImage()"><i class="icon iconfont">&#xf0226;</i>用户管理<img src="{{$resource_url}}images/left/select_xl01.png"></dt>
                <dd class="first_dd"><a href="{{$root_path}}user/index" title="用户管理">用户管理</a></dd>
             ...
             <dl class="custom">
                ...
                <dd class="first_dd"><a href="{{$root_path}}marlboro/ps">修图审核</a></dd>
                <dd><a href="#">录入审核</a></dd>
            </dl>
			 <dl class="custom">
