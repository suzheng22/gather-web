     ...
     <div class="main">
        ...
        <div class="viewport_main">
        	<div class="rose_box cc_box">
				...
				<form action="{{$root_path}}statistics/psList">
                  <div class="cc_top_one last_show"><label>项目名称:</label>
                    ...
                    <div class="cc_top_two" style="margin-left:14px; display:inline;">
                    	<a href="{{$root_path}}statistics/extPs?p={{$p}}" class="query"><i class="icon iconfont">&#xf0220;</i>导出</a>
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td>{{$list.passRate}}</td>
                        <td>{{$list.retouchPassPicCount}}</td>
                        <td>{{$list.retouchPicCount}}</td>
                        <td><a href="{{$root_path}}statistics/psDetail/{{$list.userId}}">详细</a></td>
                 	</tr>
					{{/foreach}}
                    </table>
                </div>
