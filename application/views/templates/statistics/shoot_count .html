                  ...
                  <div class="cc_top_one last_show"><label>项目名称:</label>
                    ...
                    <div class="cc_top_one last_show"><label>用户组:</label>
                        ...
                        <div style="width:40%;" class="cc_top_one">
                            <label>拍摄时间:</label>
                            <input type="text" value="" name="startTime" id="datetimepicker_start">
                            <label style="width:20px;">-</label>
                            <input type="text" value="" name="endTime" id="datetimepicker_end">
                        </div>
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td>100</td>
                        <td>
                        	<a href="shoot_count_detail.html">详细</a>
                        </td>
                      </tr>
