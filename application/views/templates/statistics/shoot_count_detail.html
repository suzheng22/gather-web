        ...
        <div class="viewport_main">
        	<div class="rose_box cc_box">
                ...
                <div class="rose_top main_rignt_top clearfix">
                        ...
                        <div class="cc_top_one"><label>拍摄人:</label><span>XXX</span></div>
                        <div class="cc_top_one"><label>用户组:</label><span>90%</span></div>
                               ...
                               <dl class="select">
                                   <select class="select3">
                                     <option value="">全部</option>
                                       ...
                                       <option value="">拍摄审核通过</option>
                                       <option value="">拍摄已驳回</option>
                                  </select>
                               </dl>
                           </div>
                       </div>
